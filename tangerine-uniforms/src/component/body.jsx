  ...
  return (
    <div data-aos='fade-up' className='sm:p-6 sm:text-lg text-gray-950 p-12 text-xl flex flex-col gap-8'>
        ...
        <div data-aos='fade-up'>
          ...
          <div className='pt-8'>
            <div className='sm:flex-col sm:gap-12 sm:place-content-center flex flex-row place-content-centern gap-4'>
              <img src={Rev5} alt="" className='sm:h-32 sm:w-24 h-80 w-64'/>
              <img src={Rev6} alt="" className='sm:h-32 sm:w-24 h-80 w-64'/>
              <img src={Rev8} alt="" className='sm:h-32 sm:w-24 h-80 w-64'/>
            </div>
            <div></div>
          </div>
        </div>
